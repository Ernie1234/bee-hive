    ...
    <div className="my-16 container">
      ...
      <div className="flex md:flex-row flex-col justify-center items-center gap-10 md:gap-16 mx-auto">
        <div className="flex flex-col flex-1 gap-8">
          <h4 className="text-white text-xl">A Space to Grow, Together</h4>
          <p className="max-w-prose text-white">
            Become part of a dynamic community of forward-thinkers. At The Hive,
            we connect passionate individuals who are eager to share, learn, and
            grow.
          </p>
          <Button
            variant="hiveYellow"
